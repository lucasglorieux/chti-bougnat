    ...
    <div name="home" className='w-full h-screen relative'>
        ...
        <div className='absolute w-full h-full top-0 left-0 bg-gray-900/25'>
            <div className='absolute top-0 w-full h-full flex flex-col justify-center text-center text-white p-4'>
                ...
                <h2 className='mb-4'>Fromages & salaisons de haute qualité</h2>
                <form className='flex justify-between items-center max-w-[700px] mx-auto w-full border p-1 rounded-md text-black bg-gray-100/90'>
                    <div>
                        <input className='bg-transparent ml-5 text-2xl w-[300px] sm:w-[400px] font-[Comfortaa] focus:outline-none' type="text" placeholder="Saint-nectaire"/>
                    </div>
                    <div>
